...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <main>
        <section className="bg-zinc-950 flex min-h-screen items-center pt-24">
          <div className="mx-auto w-full max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            <h1 className="reveal reveal-delay-1 text-4xl font-black leading-tight tracking-tight sm:text-5xl lg:text-6xl">
              <span className="block">Your AI Chef That</span>
              <span className="text-white block">Knows Your Macros</span>
            </h1>

            <p className="reveal reveal-delay-2 mx-auto mt-6 max-w-3xl text-base text-zinc-300 sm:text-lg lg:text-xl">
            ...
            <div className="reveal reveal-delay-2 mx-auto mt-10 max-w-3xl rounded-2xl border border-zinc-800 bg-zinc-900 p-4 text-left sm:p-6">
        ...
        <section id="how-it-works" className="bg-zinc-950 py-24">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
            <p className="reveal text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500 sm:text-sm">
              HOW IT WORKS
            </p>
            <h2 className="reveal reveal-delay-1 mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              From fridge to plate in seconds
            </h2>

            <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-3">
              <div className="reveal rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-left">
                <div className="mb-4 flex h-8 w-8 items-center justify-center rounded-lg border border-emerald-500/30 bg-emerald-500/20 text-sm font-bold text-emerald-400">1</div>
              ...
              <div className="reveal reveal-delay-1 rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-left">
                <div className="mb-4 flex h-8 w-8 items-center justify-center rounded-lg border border-emerald-500/30 bg-emerald-500/20 text-sm font-bold text-emerald-400">2</div>
              ...
              <div className="reveal reveal-delay-2 rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-left">
                <div className="mb-4 flex h-8 w-8 items-center justify-center rounded-lg border border-emerald-500/30 bg-emerald-500/20 text-sm font-bold text-emerald-400">3</div>
        ...
        <section className="bg-black py-24">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <div className="mx-auto mt-12 grid max-w-4xl grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="reveal reveal-delay-1 card-glow rounded-2xl border-2 border-emerald-500 bg-zinc-900 p-8 text-left">
